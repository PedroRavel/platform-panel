...
System.register(['moment', 'jquery', 'lodash', 'app/core/utils/kbn', 'app/core/config', 'app/core/time_series2', 'app/plugins/sdk'], function (_export, _context) {
  ...
  var moment, $, _, kbn, config, TimeSeries, MetricsPanelCtrl, _createClass, PlatformCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('PlatformCtrl', PlatformCtrl = function (_MetricsPanelCtrl) {
        _inherits(PlatformCtrl, _MetricsPanelCtrl);

        function PlatformCtrl($scope, $injector) {
          _classCallCheck(this, PlatformCtrl);

          var _this = _possibleConstructorReturn(this, (PlatformCtrl.__proto__ || Object.getPrototypeOf(PlatformCtrl)).call(this, $scope, $injector));
        ...
        _createClass(PlatformCtrl, [{
          ...
          value: function onInitEditMode() {
            this.addEditorTab('Options', 'public/plugins/grafana-Platform-panel/editor.html', 2);
            this.addEditorTab('All Transactions', 'public/plugins/grafana-Platform-panel/transedit.html', 2);
          }
        }, {
          key: 'onDataReceived',
      ...
      PlatformCtrl.templateUrl = 'module.html';
    }
  };
});
//# sourceMappingURL=platform_ctrl.js.map
